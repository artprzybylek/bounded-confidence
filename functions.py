...
def simulate(num_of_simulations, number_of_agents, network_func, eps_left, eps_right, all_occurrences,
             ...
             index, *args, opinion_dependent=False, m=0.1):
...
if __name__ == "__main__":
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 4, 0.2)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 6, 0.2)
    """simulate_changing_eps(nx.barabasi_albert_graph, 200, 2)
    print()
    simulate_changing_eps(nx.barabasi_albert_graph, 200, 4)
    print()
    simulate_changing_eps(nx.barabasi_albert_graph, 200, 6)
    print()
    simulate_changing_eps(nx.barabasi_albert_graph, 200, 8)
    print()
    simulate_changing_eps(nx.barabasi_albert_graph, 200, 10)
    print()

    print('ws1')
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 10, 0.3)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 20, 0.3)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 30, 0.3)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 40, 0.3)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 50, 0.3)
    print()

    print('ws2')
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 20, 0.1)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 20, 0.2)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 20, 0.3)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 20, 0.4)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 200, 20, 0.5)
    print()

    print('cg')
    simulate_changing_eps(nx.complete_graph, 500)
    print()
    simulate_changing_eps(nx.complete_graph, 200)
    print()
    simulate_changing_eps(nx.complete_graph, 100)
    print()

    print('extra')
    simulate_changing_eps(nx.barabasi_albert_graph, 100, 6)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 100, 20, 0.3)
    print()
    simulate_changing_eps(nx.watts_strogatz_graph, 500, 20, 0.3)
    print()
    simulate_changing_eps(nx.barabasi_albert_graph, 500, 6)
    print()"""
